...
class BaseLayerWithLoRA(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        # TODO: Record event marking end of previous computation
        ...
        
        # TODO: Asynchronously copy input from GPU to CPU pinned memory
        ...
        
        # Perform base linear computation on GPU (F.linear)
        base_out = F.linear(x, self.base.weight, self.base.bias)
        
        # TODO: Synchronize CPU with D2H copy completion before LoRA computation
        ...
        
        # Execute LoRA CPU matmul using self._lora_cpu_matmul(...)
        out = self._lora_cpu_matmul(self.x_cpu_pinned, self.lora_A, self.lora_B)
       
        # TODO: Asynchronously copy LoRA output from CPU pinned memory to GPU
        ...
        
        # TODO: Add LoRA output to base_out on GPU (in-place)
        ...
...
class VocabEmbeddingWithLoRA(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        # TODO: Record event marking end of previous layer computations
        ...

        # TODO: Asynchronously copy input tokens from GPU to CPU pinned memory
        ...

        # Compute base embedding on GPU using self.base
        base_out = self.base(x) # Perform the base embedding operation on GPU (on the default stream)

        # TODO: Synchronize CPU with D2H copy before LoRA computation
        ...
        
        # Perform LoRA embedding on CPU:
        out = self._lora_cpu_matmul(self.x_cpu_pinned, self.lora_A, self.lora_B)
        ...
        # TODO: Asynchronously copy LoRA output from CPU pinned memory to GPU
        ...

        # TODO: Add LoRA output to base embedding on GPU
        ...
